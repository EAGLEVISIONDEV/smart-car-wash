        ...
        <div>
          ...
          <dl className="mt-10 space-y-6">
            <div>
              ...
              <dd className="mt-2 text-white">{business.address.full}</dd>
            </div>
            <div>
              <dt className="text-[10px] font-semibold uppercase tracking-[0.24em] text-cyan">
                Program
            ...
            <div>
              ...
              <dd className="mt-2">
                <a href={`tel:${business.phone}`} className="text-xl text-white hover:text-cyan">
            ...
            <div>
              ...
              <dd className="mt-3 flex flex-wrap gap-2">
                {business.amenities.map((a) => (
                  <span key={a} className="border border-white/10 px-3 py-1.5 text-[11px] text-steel">
                    {a}
                  </span>
                ))}
              </dd>
